...
var ERROR_TEXT = "Le script de contenu n'a pas \351t\351 charg\351. \312tes-vous actuellement sur le Chrome Web Store ou sur une page chrome:// ? Si vous l'\352tes, les scripts de contenu ne fonctionneront pas ici. Si ce n'est pas le cas, veuillez attendre que la page ait fini de charger ou actualiser la page.";
var SHOW_HISTORY_TITLE = "Afficher l'historique des recherches";
var HIDE_HISTORY_TITLE = "Cacher l'historique des recherches";
var SELECTED_CLASS = 'selected';
var ENABLE_CASE_INSENSITIVE_TITLE = "Activer la recherche insensible \340 la casse";
var DISABLE_CASE_INSENSITIVE_TITLE = "D\351sactiver la recherche insensible \340 la casse";
var HISTORY_IS_EMPTY_TEXT = "L'historique de recherche est vide.";
var CLEAR_ALL_HISTORY_TEXT = "Effacer l'historique";
...
function setHistoryVisibility(makeVisible) {
  ...
  if(makeVisible) {
    document.getElementById('show-history').className = SELECTED_CLASS;
  } else {
...
function setCaseInsensitiveElement() {
  ...
  function (result) {
    ...
    if(result.caseInsensitive) {
      document.getElementById('insensitive').className = SELECTED_CLASS;
    } else {
...
function toggleCaseInsensitive() {
  var caseInsensitive = document.getElementById('insensitive').className == SELECTED_CLASS;
